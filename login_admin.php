                ...
                <div class="col-sm-6">
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body">
                                <form action="proses_login.php" method="post" class="mt-5 mb-5">
                                    <center>
                                    <a class="text-center" href="index.php"> <h4>LOGIN ADMIN</h4></a>
                                    <hr>
                                        <div class="form-group">
                                            <input type="text" class="form-control text-center" style="border: none;" placeholder="Username" name="us_admin" required="">
                                        </div>
                                        <div class="form-group">
                                            <input type="password" name="ps_admin" id="pass" class="form-control text-center" style="border: none;" placeholder="Password">
                                            <input type="checkbox" onclick="change()" id="ps_admin" name="ps_admin">
                                            <label for="ps_admin" class="form-check-label mt-3">&nbsp;Show Password</label>
                                        </div>
